...
import { Bot, LayoutDashboard, ListTodo, LogOut, Newspaper, PanelLeft, Sparkles } from "lucide-react";
...
const menuItems = [
  ...
  { icon: ListTodo, label: "事项", path: "/tasks" },
  { icon: Newspaper, label: "资讯", path: "/news" },
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              AI 工作台需要登录账号，你的事项、Agent 和对话将在多设备间同步。
            </p>
          </div>
          <Button
            onClick={() => {
